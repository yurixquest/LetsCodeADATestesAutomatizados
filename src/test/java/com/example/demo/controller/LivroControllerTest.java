...
import com.example.demo.model.ObjectMapperConfig;

@SpringBootTest(classes = LivroControllerTest.class)
...
class LivroControllerTest {
    ...
    void createLivroComNome() throws Exception {
        ...
        //assertTrue(valorLivro.compareTo(BigDecimal.ZERO) > BigDecimal.ZERO, "O preço do livro deveria ser maior do que zero");
